...
const ReviewCard = ({ name, review, image }) => {
  return (
    <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out">
      <div className="text-6xl text-gray-300 text-left" style={{ fontFamily: 'Pattaya, sans-serif' }}>“</div>
      <p className="italic text-gray-600 text-left">"{review}"</p>
      <div className="text-6xl text-gray-300 text-right" style={{ fontFamily: 'Pattaya, sans-serif' }}>”</div>
